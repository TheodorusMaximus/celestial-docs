...
- **Build the Right Thing**: Are we solving a valuable problem, how do we know?
- **Build the Thing Right**: Can we deliver a robust solution in a lean way?
...
- Use pretrained classes as proxy to prove viability
...
**Strategic Objective**: Demonstrate that threat detection can run locally at flight resolution and frame rate.

#### Atomic Hypothesis
A Jetson-class edge device or similar hardware can process each video frame in 200ms or less while maintaining 70% or higher recall and 5% or fewer false positives.
...
### H5: Rapidlu Deliver Operational System
**Strategic Objective**: Follow a phased roadmap—cloud proof → edge demo → production integration—to hand over a flight-ready AI pod system. 
